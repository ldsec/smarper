...
public class Requirements {
	...
	public static void check(final ActivityBase context) {
		...
		//KO: Check root
		if (!SmarperUtil.isDeviceRooted()){
			AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
			alertDialogBuilder.setTitle(R.string.app_name);
			alertDialogBuilder.setMessage(R.string.app_noroot);
			...
			alertDialogBuilder.setPositiveButton(context.getString(android.R.string.ok),
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							androidIntent.setData(Uri.parse("https://spism.epfl.ch/smarper/smarper.html"));
		...
		if (Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1 || (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT && !SmarperUtil.isXposedInstalled(context)) ) { //KO: Check for max acceptable version as well
			AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
			alertDialogBuilder.setTitle(R.string.app_name);
			...
			alertDialogBuilder.setPositiveButton(context.getString(android.R.string.ok),
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							Intent androidIntent = new Intent(Intent.ACTION_VIEW);
							androidIntent.setData(Uri.parse("https://spism.epfl.ch/smarper/smarper.html")); //KO: changed URL
							context.startActivity(androidIntent);
						}
					});

			//KO: Add a cancel button
			alertDialogBuilder.setNegativeButton(context.getString(android.R.string.cancel),
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
		...
		//KO: Check if Xposed framework is installed
		if (SmarperUtil.isXposedInstalled(context)){
			...
			} else { //KO: If we are disabled but Xposed is there, then show this dialog
				// @formatter:off
				AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
				alertDialogBuilder.setTitle(R.string.app_name);
			...
			AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
			alertDialogBuilder.setTitle(R.string.app_name);
			alertDialogBuilder.setMessage(R.string.no_xposed);
			alertDialogBuilder.setIcon(context.getThemed(R.attr.icon_launcher));
			alertDialogBuilder.setPositiveButton(context.getString(android.R.string.ok),
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
							Intent androidIntent = new Intent(Intent.ACTION_VIEW);
							androidIntent.setData(Uri.parse("http://repo.xposed.info/module/de.robv.android.xposed.installer"));
							context.startActivity(androidIntent);
						}
					});
