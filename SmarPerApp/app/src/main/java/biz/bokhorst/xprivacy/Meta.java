...
public class Meta {
	...
	public static List<Hook> get() {
		...
		mListHook.add(new Hook("contacts", "contacts/groups", "READ_CONTACTS,WRITE_CONTACTS", 5, "3.4", null)); //KO
		mListHook.add(new Hook("contacts", "contacts/groups_summary", "READ_CONTACTS,WRITE_CONTACTS", 5, "3.4", null)); //KO
		mListHook.add(new Hook("contacts", "contacts/raw_contact_entities", "READ_CONTACTS", 5, "3.4", null)); //KO
		...
		mListHook.add(new Hook("identification", "SERIAL", "", 1, null, null).restart().noUsageData().noOnDemand()); //KO: added no on demand
		...
		mListHook.add(new Hook("storage", "content://media/external", "READ_EXTERNAL_STORAGE", 5, "3.4", null )); //KO
